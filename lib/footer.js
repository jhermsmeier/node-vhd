...
class Footer {
  ...
  parse( buffer, offset ) {
    ...
    this.dataOffset = buffer.readBigUInt64BE( offset + 16 )
    ...
    this.originalSize = buffer.readBigUInt64BE( offset + 40 )
    this.currentSize = buffer.readBigUInt64BE( offset + 48 )
  ...
  write( buffer, offset ) {
    ...
    offset = buffer.writeBigUInt64BE( this.originalSize, offset )
    offset = buffer.writeBigUInt64BE( this.currentSize, offset )
