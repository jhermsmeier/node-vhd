...
class Header {
  ...
  parse( buffer, offset ) {
    ...
    this.dataOffset = readBigUInt64BE( buffer, offset + 8 )
    this.tableOffset = readBigUInt64BE( buffer, offset + 16 )
    ...
    for( var i = 0; i < Header.PARENT_LOCATOR_COUNT; i++ ) {
      ...
      let locatorDataOffset = readBigUInt64BE( buffer, locatorOffset + 12 )
  ...
  write( buffer, offset ) {
    ...
    offset = writeBigUInt64BE( buffer, this.tableOffset, offset )
