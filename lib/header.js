...
function Header( options ) {
  ...
  this.cookie = '' // 8 bytes
  this.dataOffset = 0x0000000000000000 // 8 bytes
  this.tableOffset = 0x0000000000000000 // 8 bytes
  this.headerVersion = new VHD.Version( '1.0' ) // 4 bytes
  this.maxTableEntries = 0x00000000 // 4 bytes
  this.sectorSize = 0x00000000 // 4 bytes
  this.checksum = 0x00000000 // 4 bytes
  this.parentUniqueId = new Buffer( 16 ) // 16 bytes
  this.parentTimeStamp = new Date( VHD.EPOCH ) // 4 bytes
  this.reserved1 = Buffer.alloc( 4 ) // 4 bytes
  this.parentUnicodeName = '' // 512 bytes
  this.parentLocator = [ // 8 * 24 bytes each
    new VHD.Locator(),
    new VHD.Locator(),
    new VHD.Locator(),
    new VHD.Locator(),
  ...
  this.reserved2 = Buffer.alloc( 256 ) // 256 bytes
