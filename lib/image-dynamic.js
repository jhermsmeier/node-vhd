...
module.exports = {
  ...
  _createReadStreamDynamic( options ) {
    throw new Error( '_createReadStreamDynamic() not implemented' )
  },
  ...
  _createWriteStreamDynamic( options ) {
    throw new Error( '_createWriteStreamDynamic() not implemented' )
  },
