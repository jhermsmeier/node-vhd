...
module.exports = {
  ...
  _createReadStreamFixed( options ) {
    throw new Error( '_createReadStreamFixed() not implemented' )
  },
  ...
  _createWriteStreamFixed( options ) {
    throw new Error( '_createWriteStreamFixed() not implemented' )
  },
