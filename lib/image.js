...
class Image {
  ...
  createReadStream( options ) {
    switch( this.footer.diskType ) {
      case VHD.TYPE.FIXED: this._createReadStreamFixed( options ); break
      case VHD.TYPE.DYNAMIC: this._createReadStreamDynamic( options ); break
      case VHD.TYPE.DIFF: this._createReadStreamDiff( options ); break
      default: throw new Error( `Invalid disk type "${this.footer.diskType}"` )
    }
  }
  ...
  createWriteStream( options ) {
    switch( this.footer.diskType ) {
      case VHD.TYPE.FIXED: this._createWriteStreamFixed( options ); break
      case VHD.TYPE.DYNAMIC: this._createWriteStreamDynamic( options ); break
      case VHD.TYPE.DIFF: this._createWriteStreamDiff( options ); break
      default: throw new Error( `Invalid disk type "${this.footer.diskType}"` )
    }
  }
