...
int64.writeUIntLE = function( buffer, value, offset ) {
  offset = offset || 0
...
int64.writeUIntBE = function( buffer, value, offset ) {
  offset = offset || 0
  var hi = Math.floor( value / MAX_UINT32 )
  var lo = ( value & 0xffffffff ) >>> 0
...
int64.writeIntLE = function( buffer, value, offset ) {
  offset = offset || 0
  var hi = Math.floor( value / MAX_UINT32 )
  var lo = ( value & 0xffffffff ) >>> 0
  buffer.writeUInt32LE( hi, offset + 4 )
...
int64.writeIntBE = function( buffer, value, offset ) {
  offset = offset || 0
  var hi = Math.floor( value / MAX_UINT32 )
  var lo = ( value & 0xffffffff ) >>> 0
