...
VHD.SparseReadStream = require( './sparse-read-stream' )
VHD.SparseWriteStream = require( './sparse-write-stream' )

VHD.createReadStream = function( path, options ) {
  options = Object.assign({ path }, options )
  return new VHD.ReadStream( options )
}

VHD.createSparseReadStream = function( path, options ) {
  options = Object.assign({ path }, options )
  return new VHD.SparseReadStream( options )
}

VHD.createWriteStream = function( path, options ) {
  options = Object.assign({ path }, options )
  return new VHD.WriteStream( options )
}

VHD.createSparseWriteStream = function( path, options ) {
  options = Object.assign({ path }, options )
  return new VHD.SparseWriteStream( options )
}
